	...
	<body class="fixed-navigation ">
		...
		<header id="header">
			<div id="logo-group">
				...
				<span id="logo"> <img src="<?php echo base_url();?>assets/img/logo-pale.png" alt="SmartAdmin"> </span>
			...
			<div class="pull-right">
				...
				<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
					<li class="">
						<a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown"> 
							<img src="<?php echo base_url();?>files/user_photos/<?php echo $_SESSION['username'];?>.jpg" alt="<?php echo $_SESSION['username']?>" class="online" />  
						</a>
				...
				<div id="logout" class="btn-header transparent pull-right">
					<span> <a href="<?php echo base_url();?>login/logout" title="Sign Out" data-action="userLogout" data-logout-msg="Keluar dari sistem ?"><i class="fa fa-sign-out"></i></a> </span>
				</div>
				<!-- end logout button -->
