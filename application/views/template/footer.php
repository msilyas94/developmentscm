<!-- PAGE FOOTER -->
		<div class="page-footer">
			<div class="row">
				<div class="col-xs-12 col-sm-6">
					<span class="txt-color-white">Copyright by SCM - Telkom Akses <span class="hidden-xs"> - Vendor management System </span>© 2014-2015</span>
				</div>
		...
		<script src="http://ajax.googleapis.com/<?php echo base_url();?>assets/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
		<script>
			if (!window.jQuery) {
		...
		<script src="http://ajax.googleapis.com/<?php echo base_url();?>assets/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js"></script>
		<script>
			if (!window.jQuery.ui) {
