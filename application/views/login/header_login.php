...
<html lang="en-us" id="extr-page">
	<head>
		...
		<link rel="stylesheet" type="text/css" media="sccreen" href="<?php echo base_url();?>assets/css/smartadmin-rtl.min.css"> 
	...
	<body class="animated fadeInDown">
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Membuat Akun Mitra Baru ?</span> <a href="<?php echo base_url();?>login/register" class="btn btn-danger">Buat Akun</a> </span>
